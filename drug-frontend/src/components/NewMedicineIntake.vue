<template>
  <div>
    <b-button
      ...
      v-b-modal.voeg-Inname-toe-modal
      class="ml-2 mr-2"
    >
    ...
    >
      <b-form v-if="show">
        <b-row>
          <b-col cols="6">
<b-form-group id="input-group-1" label="Hoeveelheid:" label-for="input-1">
          <b-form-input
            id="input-1"
            type="number"
            v-model="form.dosage"
          ...
          <b-col cols="6">
            <b-form-group id="input-group-1" label="Doserings vorm:" label-for="input-1">
          <b-form-input
            id="input-1"
            type="text"
...
export default {
  ...
  data() {
    return {
      ...
      frequency: [
        { text: "Dagelijks", value: 0 },
        { text: "Wekelijks", value: 1 },
        { text: "Zelf instellen", value: 2 },
      ],
      show: true,
    };
  },
  methods: {
    addIntake() {
      const NEWINTAKE = {
        ...
        dosage: this.form.dosage + " " + this.form.dosageForm,
